...
static struct sockaddr *
init_sockaddr_ll(JNIEnv *env, struct sockaddr_ll *sll, jbyteArray address,
				 int sll_ifindex)
{
	jbyte *buf;

	memset(sll, 0, sizeof(struct sockaddr_ll));
	sll->sll_ifindex = sll_ifindex;
	sll->sll_halen = ETH_ALEN;
	buf = (*env)->GetByteArrayElements(env, address, NULL);
	memcpy(&sll->sll_addr, buf, sizeof(sll->sll_addr));
	(*env)->ReleaseByteArrayElements(env, address, buf, JNI_ABORT);

	return (struct sockaddr *)sll;
}
...
Java_com_savarese_rocksaw_net_RawSocket__1_1RockSawStartup(JNIEnv *env, jclass cls)
{
#if defined(_WIN32)
...
Java_com_savarese_rocksaw_net_RawSocket__1_1RockSawShutdown(JNIEnv *env, jclass cls)
{
#if defined(_WIN32)
	WSACleanup();
#endif
 ...
 */
JNIEXPORT void JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1getErrorMessage(JNIEnv *env, jclass cls, jobject buffer)
{
	jclass sbc;
	jstring str;
	jmethodID mid;
...
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1select(JNIEnv *env, jclass cls, jint socket, jboolean read, jint milliseconds)
{
	int result;
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1PF_1INET(JNIEnv *env, jclass cls)
{
	return PF_INET;
}
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1PF_1INET6(JNIEnv *env, jclass cls)
{
	return PF_INET6;
}
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1PF_1PACKET(JNIEnv *env, jclass cls)
{
	return PF_PACKET;
}
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1socket(JNIEnv *env, jclass cls, jint family, jint protocol)
{
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1bind(JNIEnv *env, jclass cls, jint socket, jint family, jbyteArray address,
												 jint scope_id)
{
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1bindDevice(JNIEnv *env, jclass cls, jint socket, jstring device)
{
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket_getProtocolByName(JNIEnv *env, jclass cls, jstring name)
{
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1query_1routing_1interface(JNIEnv *env, jclass cls, jint socket, jint family,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1close(JNIEnv *env, jclass cls, jint socket)
{
	return close(socket);
}
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1recvfrom1(JNIEnv *env, jclass cls, jint socket,
													  jbyteArray data, jint offset, jint len, jint family)
{
	int result;
	jbyte *buf;

	if (family != PF_INET && family != PF_INET6 && family != PF_PACKET)
	{
		errno = EINVAL;
		return errno;
	}
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1recvfrom2(JNIEnv *env, jclass cls, jint socket,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1sendto(JNIEnv *env, jclass cls, jint socket,
												   jbyteArray data, jint offset, jint len, jint family, jbyteArray address,
												   jint scope_id)
{
	int result;
	...
	union {
		...
		struct sockaddr_in6 sin6;
		/**
		 * @brief For send PF_PACKET
		 * will reuse scope_id as ifr_ifindex to construct sockaddr_ll
		 *
		 */
	...
	{
		socklen = sizeof(sin.sll);
		saddr = init_sockaddr_ll(env, &sin.sll, address, scope_id);
	}
	else
	{
		errno = EINVAL;
...
Java_com_savarese_rocksaw_net_RawSocket__1_1isErrorEAGAIN(JNIEnv *env, jclass cls)
{
#if defined(_WIN32)
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1setIPHeaderInclude(JNIEnv *env, jclass cls, jint socket, jboolean on)
{
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1getIPHeaderInclude(JNIEnv *env, jclass cls, jint socket)
{
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1setSendBufferSize(JNIEnv *env, jclass cls, jint socket, jint size)
{
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1getSendBufferSize(JNIEnv *env, jclass cls, jint socket)
{
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1setReceiveBufferSize(JNIEnv *env, jclass cls, jint socket, jint size)
{
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1getReceiveBufferSize(JNIEnv *env, jclass cls, jint socket)
{
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1setSendTimeout(JNIEnv *env, jclass cls, jint socket, jint timeout)
{
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1getSendTimeout(JNIEnv *env, jclass cls, jint socket)
{
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1setReceiveTimeout(JNIEnv *env, jclass cls, jint socket, jint timeout)
{
 ...
 */
JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1getReceiveTimeout(JNIEnv *env, jclass cls, jint socket)
{
	return gettimeout(socket, SO_RCVTIMEO);
}

JNIEXPORT jint JNICALL
Java_com_savarese_rocksaw_net_RawSocket__1_1getIfIndex(JNIEnv *env, jclass cls, jint socket, jstring if_name)
{
	const char *utf = (*env)->GetStringUTFChars(env, if_name, NULL);
	struct ifreq if_idx;
	memset(&if_idx, 0, sizeof(struct ifreq));
	strncpy(if_idx.ifr_name, utf, (*env)->GetStringLength(env, if_name));
	(*env)->ReleaseStringUTFChars(env, if_name, utf);
...
Java_com_savarese_rocksaw_net_RawSocket__1_1getIfHwAddr(JNIEnv *env, jclass cls, jint socket, jstring if_name)
{
	const char *utf = (*env)->GetStringUTFChars(env, if_name, NULL);
	struct ifreq if_mac;
	memset(&if_mac, 0, sizeof(struct ifreq));
	strncpy(if_mac.ifr_name, utf, (*env)->GetStringLength(env, if_name));
	(*env)->ReleaseStringUTFChars(env, if_name, utf);
	...
	{
		jbyteArray data = (*env)->NewByteArray(env, ETH_ALEN);
		(*env)->SetByteArrayRegion(env, data, 0, ETH_ALEN, (jbyte *)if_mac.ifr_hwaddr.sa_data);
		return data;
	}
}